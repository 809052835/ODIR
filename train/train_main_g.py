...
from user_defined.metric_g import Roc_Callback
...
if __name__ == '__main__':
    ...
    model_savePath = r'H:\Qiulin\ODIR\model\v6\vgg16_g_v2.h5'
    annotation = r'H:\Qiulin\ODIR\ODIR_dataset\ODIR-5K_training-Chinese_modified_v1.xlsx'
    ODIR_trainDir = r'H:\Qiulin\ODIR\ODIR_dataset\ODIR-5K_training_cvt\v3_train_aug_equ_g'
